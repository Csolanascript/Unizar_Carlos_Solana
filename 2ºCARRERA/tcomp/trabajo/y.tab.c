...
{
  "$end", "error", "$undefined", "FLECHA", "OP", "CP", "COMA",
  "PUNTOCOMA", "NUM", "EOL", "$accept", "inicio", "estOrigen",
  "transicion", "transiciones", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 3:
#line 92 "th2.y" /* yacc.c:1646  */
    { listaTr.total = 0; }
#line 1295 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 96 "th2.y" /* yacc.c:1646  */
    { listaTr.nodoOrig = (yyvsp[0].nombre); }
#line 1301 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 99 "th2.y" /* yacc.c:1646  */
    { listaTr.nodosFin[listaTr.total] = (yyvsp[-3].nombre);
					  listaTr.etiquetas[listaTr.total] = (yyvsp[-1].nombre); 
